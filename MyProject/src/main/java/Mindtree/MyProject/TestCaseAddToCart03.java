...
public class TestCaseAddToCart03 {
...
public static void main(String[] args) throws InterruptedException {
	...
	System.setProperty("webdriver.chrome.driver", "C:\\Program Files\\chromedriver.exe");
		...
		driver.findElement(By.id("order_ship_address_attributes_firstname")).sendKeys("Rajesh",Keys.TAB);
		driver.findElement(By.id("order_ship_address_attributes_lastname")).sendKeys(Keys.CLEAR,"Zambare",Keys.TAB);
		driver.findElement(By.id("order_ship_address_attributes_phone")).sendKeys("7387456155");
